...
public class Body implements Serializable, Parcelable
{
    ...
    public final static Parcelable.Creator<Body> CREATOR = new Creator<Body>() {
        ...
        public Body[] newArray(int size) {
            ...
            ;
    private final static long serialVersionUID = 1420499586500406656L;
     ...
     * @param url
     */
    public Body(String url, String location, String name, String shortName, String tariffZone, Municipality municipality) {
        super();
        this.url = url;
