...
public class Journey implements Serializable, Parcelable
{
    ...
    public final static Parcelable.Creator<Journey> CREATOR = new Creator<Journey>() {
        ...
        public Journey[] newArray(int size) {
            ...
            ;
    private final static long serialVersionUID = -1975481977603996151L;
    ...
    protected Journey(Parcel in) {
        ...
        in.readList(this.dayTypeExceptions, (com.example.programmer.tamperelinjat.model.routes.DayTypeException.class.getClassLoader()));
    }
